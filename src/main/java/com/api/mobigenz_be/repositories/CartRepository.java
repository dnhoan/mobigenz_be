...
public interface CartRepository extends JpaRepository<Cart, Integer> {
	...
	Cart getCartByCustomerId(@Param("customer_id") Integer customer_id);
	
	@Query("select new com.api.mobigenz_be.DTOs.ProductDetailCartDto(pd.id, pd.price, pd.sku, pd.image, pd.stock, pd.productName)"
